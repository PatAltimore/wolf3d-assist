...
LDFLAGS="-sASYNCIFY -sINITIAL_MEMORY=64MB -sALLOW_MEMORY_GROWTH=1 -sENVIRONMENT=web --preload-file data@/ --shell-file ../web/shell.html -sEXPORTED_FUNCTIONS=_main,_assist_get_current_level -sEXPORTED_RUNTIME_METHODS=ccall,cwrap -O2"
